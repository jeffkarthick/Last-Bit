...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Keep the WhatsApp chat reasonably small
...
- Focus on communication style, tone, topics and observable patterns.
        ...
        messages: [
          {
            role: "system",
            content:
              "You are a careful WhatsApp conversation analysis AI. Return valid JSON only."
          },
          {
            role: "user",
            content: prompt
